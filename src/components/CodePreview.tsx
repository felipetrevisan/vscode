    ...
    <>
      {raw && (
        <button
          ...
          className="absolute flex items-center right-0 mx-8 gap-x-2 text-sm font-medium z-30 bg-black/50 px-3 py-2 rounded-md text-[#E0DEF2] ring-2 ring-[#2b283b] data-[copied=true]:ring-emerald-600"
        >
      ...
      <div
        ...
        className="absolute inset-0 overflow-auto leading-relaxed scrollbar scrollbar-thumb-[#000000]/40 scrollbar-track-transparent"
